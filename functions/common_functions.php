...
function search_product() {
    ...
    if (isset($_GET['search_data'])) {
        ...
        $search_product_query = "SELECT * FROM products WHERE product_title LIKE '%$search_query%'";
                            ...
                            <div class='delivery d-flex flex-column my-4 gap-3'>
                                <div class='d-flex gap-2 align-items-center'>
                                    ...
                                    <div class='d-flex flex-column gap-2'>
                                        <h6>Biratnagar Delivery Only Free</h6>
                                        <span>Enter your Ward Number and Address</span>
                                    </div>
                                </div>
                                <div class='d-flex gap-2 align-items-center'>
                                    <span>
                                    ...
                                    <div class='d-flex flex-column gap-2'>
                                        ...
                                        <span>Warrenty all devices 1 year only.</span>
                                    </div>
                                </div>
                            </div>
                        </div>
